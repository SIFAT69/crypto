            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="{!! route('dashboard') !!}">
                        <img src="{!! asset('img/fLogo.png') !!}" width="300px" alt="logo">
                    </a>
                </li>
          ...
          <div class="layout-px-spacing">
            ...
            <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © {{ \Carbon\Carbon::now()->format('Y') }} <a target="_blank" href="#"> {!! env('APP_NAME') !!} </a>, All rights reserved.</p>
                </div>
                <div class="footer-section f-section-2">
                    <p class="">Coded By <a href="https://sifztech.com/" target="_blank">SIFZTECH</a> </p>
                </div>
            </div>
        </div>
        <!--  END CONTENT AREA  -->
